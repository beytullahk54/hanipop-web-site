        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-600 flex flex-col scale-105 relative">
              ...
              <div className="text-3xl font-bold text-blue-600 mb-2">₺3.500 <span className="text-base font-medium text-gray-500">yıllık</span></div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 flex flex-col">
              ...
              <div className="text-3xl font-bold text-blue-600 mb-2">₺5.999 <span className="text-base font-medium text-gray-500">yıllık</span></div>
